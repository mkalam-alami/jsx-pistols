...
exports.transpileTsx = exports.defaultBabelOptions = void 0;
...
function babelTransform(tsxSources, absolutePath, babelOptions) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, babel.transformAsync(tsxSources, __assign(__assign({}, babelOptions), { filename: absolutePath }))];
                case 1:
