...
var Cache = /** @class */ (function () {
    function Cache(options) {
        var disableCache = options.disableCache !== undefined ? options.disableCache : process.env.NODE_ENV !== 'production';
        if (!disableCache) {
    ...
    Cache.prototype.wrap = function (key, valueSupplier) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3: return [2 /*return*/, valueSupplier()];
                }
            });
        });
    };
